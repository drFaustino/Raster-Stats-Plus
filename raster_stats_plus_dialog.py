...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'raster_stats_plus_dialog_base.ui'))


class RasterStatsPlusDialog(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, parent=None):
        """Constructor."""
        super(RasterStatsPlusDialog, self).__init__(parent)
